...
<div class="col-sm-8 text-left"> 
   <div class="container">
  <center><h2 style="color:red">ADD EVENT</h2></center></br>
 <form name="myForm" class="form-horizontal" action="eventlink.php" method="POST" onsubmit="return validateForm()">


    <div class="form-group">
      <label class="control-label col-sm-2" for="email"><h4 style="color:#c27e79">Event Name:</h4></label>
      <div class="col-sm-10">
...
<div class="form-group">
      <label class="control-label col-sm-2" for="email"><h4 style="color:#c27e79">Event ID:</h4></label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="eid" name="eid" placeholder="Enter Enter">
      </div>
    </div>

<div class="form-group">
      <label class="control-label col-sm-2" for="email"><h4 style="color:#c27e79">Institute Code:</h4></label>
      <div class="col-sm-10">
     ...
     <div class="form-group">
      <label class="control-label col-sm-2" for="Date"><h4 style="color:#c27e79">Date:</h4></label>
      <div class="col-sm-5">          
     ...
     <div class="form-group">
      <label class="control-label col-sm-2" for="Date"><h4 style="color:#c27e79">Time:</h4></label>
      <div class="col-sm-5">          
...
<div class="form-group">
      <label class="control-label col-sm-2" for="email"><h4 style="color:#c27e79">Venue:</h4></label>
      <div class="col-sm-10">
...
<div class="form-group">
      <label class="control-label col-sm-2" for="email"><h4 style="color:#c27e79">Description:</h4></label>
      <div class="col-sm-10">
        
	<textarea rows="7" cols="153" placeholder="Description" id="desc" name="desc"></textarea>
      </div>
    </div>
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
         ...
         <div>
       <button type="submit" class="btn btn-default"  value="submit" style="background-color: #f18973;padding: 11px 32px;text-align: center;border-radius: 8px;font-size: 18px;color: white;"><a href="addevent.php">Cancel</a></button>
 
 <div class="col-sm-offset-0 col-sm-4">
<button type="submit" class="btn btn-default" onsubmit="return validateForm()" value="submit" style="background-color: #f18973;padding: 11px 32px;text-align: center;border-radius: 8px;font-size: 18px;color: white;">Upload</button>
   </div>     
</div>
...
var f = document.forms["myForm"]["venue"].value;
var g = document.forms["myForm"]["desc"].value;
